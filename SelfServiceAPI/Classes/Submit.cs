...
namespace SelfServiceAPI.Classes
{
    public class Submit
    {
        ...
        public static int InsertApplication(ApplicationFormEntities entities, ApplicationInfo applicationInfo, int applicationProgamSettingsId)
        {
        ...
        internal static void InsertApplicationUserDefined(ApplicationFormEntities entities, List<ApplicationUserDefinedInfo> lstUserDefined, int applicationId)
        {
        ...
        internal static void InsertApplicationProgram(ApplicationFormEntities entities, AcademicInterest academicInterest, int applicationId)
        {
        ...
        internal static void InsertApplicationCampus(ApplicationFormEntities entities, AcademicInterest academicInterest, int applicationId)
        {
            string levelDesc = string.Empty;
            string secondLevelDesc = string.Empty;
            if (academicInterest == null) throw new ArgumentNullException("applicationInterest");
        ...
        internal static void InsertApplicationEducation(ApplicationFormEntities entities, List<EducationInfo> lstPriorEducation, int applicationId)
        {
        ...
        internal static void InsertApplicationAttachment(ApplicationFormEntities entities, Submit attachment, int applicationId)
        {
        ...
        internal static void InsertApplicationRelationShip(ApplicationFormEntities entities, List<ApplicationRelationInfo> lstApplicationRelations, int applicationId)
        {
        ...
        internal static void InsertApplicationSiblingRelationShip(ApplicationFormEntities entities, PersonalInfo personalInfo, int applicationId, int? siblingPrefixId)
        {
        ...
        internal static void InsertApplicationTestScore(ApplicationFormEntities entities, List<ApplicationTestScoreInfo> lstTestScore, int applicationId)
        {
        ...
        internal static void InsertApplicationTests(ApplicationFormEntities entities, List<ApplicationTestsInfo> lstTests, int applicationId)
        {
        ...
        internal static void InsertApplicationAddress(ApplicationFormEntities entities, List<AddressInfo> lstAddress, int applicationId)
        {
           ...
           // string cityName = "";
            ...
            foreach (AddressInfo address in lstAddress)
            {
                ...
                address.State.HasValue && address.State.Value > 0 ? (int?)address.State.Value : null,
                null, null,
        ...
        public static void InsertApplicationPhone(ApplicationFormEntities entities, List<PhoneNumberInfo> lstPhoneType, int applicationId)
        {
        ...
        public static void InsertApplicationSource(ApplicationFormEntities entities, List<ApplicationSourceInfo> lstSource, int applicationId)
        {
        ...
        internal static void InsertApplicationEmployment(ApplicationFormEntities entities, List<EmploymentInfo> lstEmployment, int applicationId)
        {
