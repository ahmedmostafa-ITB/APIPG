...
namespace DataAccess
{
    ...
    public partial class CODE_FORUMUSERLEVEL
    {
        ...
        public string ADMIN_CATEGORY { get; set; }
        public string ADMIN_FORUM { get; set; }
        public string ADMIN_TOPIC { get; set; }
        public string ADMIN_POSTS { get; set; }
        public string ADMIN_USERS { get; set; }
        public string MODERATE_FORUM { get; set; }
