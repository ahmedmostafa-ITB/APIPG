...
namespace DataAccess
{
    ...
    public partial class CODE_COMMUNITYMEMBERSTATUS
    {
        ...
        public string MEMBERSHIP_RESTRICTIONS { get; set; }
        public string TIMEOUT_NEW_STATUS { get; set; }
        public string TIMEOUT_UNIT { get; set; }
