...
namespace DataAccess
{
    ...
    public partial class STDDEGREQ
    {
        ...
        public decimal CREDITS_TAKEN { get; set; }
        public int COURSES_TAKEN { get; set; }
        ...
        public int ACA_PLAN_SEQ { get; set; }
        public decimal MIN_OVERALL_GPA { get; set; }
        public decimal MIN_DEGREE_GPA { get; set; }
        public string COMPLETED { get; set; }
        public decimal OVERALL_GPA { get; set; }
        public decimal DEGREE_GPA { get; set; }
