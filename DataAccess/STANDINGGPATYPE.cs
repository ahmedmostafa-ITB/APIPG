...
namespace DataAccess
{
    ...
    public partial class STANDINGGPATYPE
    {
        public string GPA_TYPE { get; set; }
        public string GPA_TYPE_DESC { get; set; }
        public string GPA_TYPE_SP_NAME { get; set; }
        public string CRDHRDL_DESC { get; set; }
        public string CRDHRDL_SP_NAME { get; set; }
