...
namespace DataAccess
{
    ...
    public partial class TRANSCRIPTPENDING
    {
        public int TRANSCRIPTPENDING_KEY { get; set; }
        ...
        public string MID_APPROVED_BY { get; set; }
        public string MID_GRADE { get; set; }
        public Nullable<decimal> MID_POINTS { get; set; }
        public string FINAL_APPROVED_BY { get; set; }
        public string FINAL_GRADE { get; set; }
        public Nullable<decimal> FINAL_POINTS { get; set; }
