...
namespace DataAccess
{
    ...
    public partial class CODE_GIFTCLUBRPTLEVELS
    {
        public string GIFTCLUB_REPORT { get; set; }
        public string GIFT_CLUB { get; set; }
        public decimal LOW_GIFT_AMOUNT { get; set; }
        public decimal HIGH_GIFT_AMOUNT { get; set; }
